 ...
 */
export const OPS: Op[] = [delegate, threadsList, threadsGet, wait, status];
...
export { delegate, threadsList, threadsGet, wait, status, listAllThreads, pollUntilTerminal, waitForThread };
